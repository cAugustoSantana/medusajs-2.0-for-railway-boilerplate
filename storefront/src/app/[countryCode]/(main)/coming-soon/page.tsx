...
export default function ComingSoonPage() {
  ...
  return (
    <div className="coming-soon-page min-h-screen w-full relative bg-gradient-to-br from-grey-90 via-grey-80 to-grey-70 flex items-center justify-center">
      {/* Video Background */}
      <video
        autoPlay
        loop
      ...
      <div className="relative z-10 w-full max-w-2xl mx-auto px-6 text-center">
        {/* Email Signup Form */}
        <div className="bg-white backdrop-blur-none p-8 small:p-12   shadow-none">
          {state?.success ? (
            <div className="text-center">
              ...
              <Heading
                level="h2"
                className="text-3xl font-black text-black mb-4 uppercase"
              >
                Thank You!
              </Heading>
                ...
                <div className="flex flex-col small:flex-row gap-4">
                  <div className="flex-1">
                    <Input
                      ...
                      required
                      autoComplete="email"
                      className="bg-white rounded-none border-2 border-black focus:border-black"
                      data-testid="email-input"
                    />
                  </div>
                  <div className="flex items-end">
                    <SubmitButton 
                      className="w-full small:w-auto whitespace-nowrap rounded-none border-2 border-white font-black uppercase"
        ...
        {/* Social Links */}
        <div className="mt-12">
          <Text className="text-base font-bold uppercase text-white mb-6">
          ...
          <div className="flex items-center justify-center gap-8">
            ...
            {/* Spotify */}
            <a
              href="https://spotify.com/#REPLACE_WITH_SPOTIFY_LINK"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white hover:text-white/80 transition-colors"
              aria-label="Spotify"
